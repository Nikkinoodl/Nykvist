...
C:\user\<username>\AppData\Roaming\GIMP\2.10\plugins\gimp_nykvist.py
C:\user\<username>\AppData\Roaming\GIMP\3.0\plugins\gimp_nykvist\gimp_nykvist.py
...
/usr/<username>/.config/GIMP/2.10/plugins/gimp_nykvist.py
/usr/<username>/.config/GIMP/3.0/plugins/gimp_nykvist/gimp_nykvist.py
```
